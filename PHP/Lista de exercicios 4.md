### Criar um pequeno sistema de cadastro de usuários, o sistema deverá permitindo cadastrar usuários (nome, email, senha, data de nascimento, cpf, rg) esses dados serão salvos num arquivo txt.
